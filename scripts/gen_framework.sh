...
# ARM64 Device
scons platform=ios target=$2 arch=arm64 target_name=$1 version=$3
# ARM7 Device
scons platform=ios target=$2 arch=armv7 target_name=$1 version=$3
# x86_64 Simulator
scons platform=ios target=$2 arch=x86_64 simulator=yes target_name=$1 version=$3
# ARM64 Simulator
scons platform=ios target=$2 arch=arm64 simulator=yes target_name=$1 version=$3
